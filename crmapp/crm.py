...
class CRMInv(models.Model):
    ...
    tax_percent = models.DecimalField(max_digits=, db_column='fTaxPerc', decimal_places=2, default='0.05') 
...
class CRMPil(models.Model):  
    ...
    probability_percent = models.IntegerField(db_column='nProbPerc', default = )
